...
void delay_ms(long ms) {
    ...
    while (ms > 0) {
        ...
        TF0 = 0;  // Xóa cờ tràn Timer 0 Chuẩn bị cho lần đếm tiếp theo và Ngăn ngắt không mong muốn
...
// Khởi tạo ngắt ngoài 0 và 1: thiết lập ngắt ngoài cho các chân P3.2 (INT0) và P3.3 (INT1), cho phép ngắt ngoài khi có cạnh xuống.
...
// Xử lý ngắt ngoài 0: chuyển hiệu ứng hiện tại sang hiệu ứng trước đó. Nếu đang ở hiệu ứng 1, chuyển sang hiệu ứng 3.
...
// Xử lý ngắt ngoài 1: chuyển hiệu ứng hiện tại sang hiệu ứng tiếp theo. Nếu đang ở hiệu ứng 3, chuyển sang hiệu ứng 1.
